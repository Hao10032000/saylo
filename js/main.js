!(function (a) {
        ...
        n = function () {
            ...
            e.on("click", function (e) {
                ...
                a(".modal-menu__body #mainnav-secondary .menu li").each(function (e) {
                    ...
                    0 == a(".modal-menu__body #mainnav-secondary .menu li:has(ul)").find(">span").length && a(".modal-menu__body #mainnav-secondary .menu li:has(ul)").append('<span class="icon-saylo-ona-38"></span>'),
            ...
            e.length > 0 &&
                ...
                e.each(function () {
                    ...
                    a(this).owlCarousel({
                        ...
                        navText: ['<i class="icon-saylo-arrow-right"></i>', '<i class="icon-saylo-arrow-left1"></i>'],
    ...
    var q = function () {
        ...
        a(".widget.widget_nav_menu h4").on("click", function () {
