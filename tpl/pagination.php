...
$links = paginate_links( array(
	...
	'prev_text' => ( '<i class="icon-saylo-chevron-left"></i>' ),

	'next_text' => ( '<i class="icon-saylo-chevron-right1"></i>' ),
...
$next_link = get_next_posts_link( esc_html__( 'Next', 'saylo' ) );

$prev_link = get_previous_posts_link( esc_html__( 'Previous', 'saylo' ) );

$loadmore_text = apply_filters('themesflat/template/loadmore_text',esc_html__('Load More','saylo'));
