	...
	class themesflat_Typography extends WP_Customize_Control {
		...
		public function render_content() {
			...
			$this->titles = array(
				...
				'100'        => esc_html__( 'Thin 100', 'saylo' ),

				'100italic'  => esc_html__( 'Thin 100 italic', 'saylo' ),

				'200'        => esc_html__( 'Extra-light 200', 'saylo' ),

				'200italic'  => esc_html__( 'Extra-light 200 italic', 'saylo' ),

				'300'        => esc_html__( 'Light 300', 'saylo' ),

				'300italic'  => esc_html__( 'Light 300 italic', 'saylo' ),

				'400'        => esc_html__( 'Normal 400', 'saylo' ),

				'400italic'  => esc_html__( 'Normal 400 italic', 'saylo' ),

				'regular'    => esc_html__( 'Normal 400', 'saylo' ),

				'italic'     => esc_html__( 'Normal 400 italic', 'saylo' ),

				'500'        => esc_html__( 'Medium 500', 'saylo' ),

				'500italic'  => esc_html__( 'Medium 500 italic', 'saylo' ),

				'600'        => esc_html__( 'Semi-bold 600', 'saylo' ),

				'600italic'  => esc_html__( 'Semi-bold 600 italic', 'saylo' ),

				'700'        => esc_html__( 'Bold 700', 'saylo' ),

				'700italic'  => esc_html__( 'Bold 700 italic', 'saylo' ),

				'800'        => esc_html__( 'Extra-bold 800', 'saylo' ),

				'800italic'  => esc_html__( 'Extra-bold 800 italic', 'saylo' ),

				'900'        => esc_html__( 'Ultra-bold 900', 'saylo' ),

				'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'saylo' )
			...
			$this->titles_subsets = array(
				...
				"cyrillic-ext"  => esc_html__("Cyrillic Extended",'saylo'),

			    "greek" 		=> esc_html__("Greek",'saylo'),

			    "greek-ext"		=>	esc_html__("Greek Extended",'saylo'),

			    "latin-ext"		=>	esc_html__("Latin Extended",'saylo'),

			    "cyrillic"		=>	esc_html__("Cyrillic",'saylo'),

			    "vietnamese"	=>	esc_html__("Vietnamese",'saylo'),

			    "latin" 		=> esc_html__("Latin",'saylo')
			...
			<div class="themesflat-options-control-inputs">					
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-font">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label for="<?php  echo esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'saylo' ) ?></label>
					...
					<div class="themesflat-options-control-inputs">
						...
						<select name="<?php  echo esc_attr( $name ) ?>[family]" id="<?php  echo esc_attr( $name ) ?>-family" class="select-choosen" >
							...
							<optgroup label="<?php echo esc_html( 'Google Fonts', 'saylo' ) ?>">
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-style">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label><?php esc_html_e( 'Font Weight & Style', 'saylo' ) ?></label>
				...
				<?php if ( in_array( 'subsets', $this->fields ) ): ?>
					...
					<div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
						...
						<div class="themesflat-options-control-title customize-control-title">
							...
							<label><?php esc_html_e( 'Font subsets', 'saylo' ) ?></label>
				...
				<div class="themesflat-typography-group typography-size">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label for="<?php  echo esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'saylo' ) ?></label>
				...
				<div class="themesflat-typography-group typography-line_height">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label for="<?php  echo esc_attr( $name ) ?>-line_height"><?php esc_html_e( 'Line height ( ex: 25px or 1.8 or 150% )', 'saylo' ) ?></label>
				...
				<div class="themesflat-typography-group typography-letter_spacing">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label for="<?php  echo esc_attr( $name ) ?>-letter_spacing"><?php esc_html_e( 'Letter Spacing ( Value in px or em )', 'saylo' ) ?></label>
				...
				<div class="themesflat-typography-group themesflat-options-control-color-picker typography-color">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label><?php esc_html_e( 'Font Color', 'saylo' ) ?></label>
