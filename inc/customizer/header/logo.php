...
$wp_customize->add_control(
    ...
    new WP_Customize_Image_Control(
        ...
        array(
           ...
           'label'          => esc_html__( 'Upload Logo Sticky ', 'saylo' ),
...
$wp_customize->add_control(
    ...
    new WP_Customize_Image_Control(
        ...
        array(
           ...
           'label'          => esc_html__( 'Upload Your Logo On Mobile', 'saylo' ),
