...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        ...
        'label' => esc_html__('Smooth Scroll ( OFF | ON )', 'saylo'),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        ...
        'label' => esc_html__('Preload ( OFF | ON )', 'saylo'),
...
$wp_customize->add_control( new themesflat_RadioImages($wp_customize,
    ...
    array (
        ...
        'label'         => esc_html__('Preload', 'saylo'),

        'choices'   => array (

            'preload-1' => array (

                'tooltip'   => esc_html__( 'Circle Loaders 1','saylo' ),
            ...
            //     'tooltip'   => esc_html__( 'Circle Loaders 2','saylo' ),
            ...
            'preload-4'=>  array (
                ...
                'tooltip'   => esc_html__( 'Circle Loaders 3','saylo' ),
            ...
            'preload-5'=>  array (
                ...
                'tooltip'   => esc_html__( 'Spinner Loaders','saylo' ),
            ...
            'preload-6'=>  array (
                ...
                'tooltip'   => esc_html__( 'Pulse Loaders','saylo' ),
            ...
            'preload-7'=>  array (
                ...
                'tooltip'   => esc_html__( 'Square Loaders','saylo' ),
            ...
            'preload-8'=>  array (
                ...
                'tooltip'   => esc_html__( 'Line Loaders','saylo' ),
...
$wp_customize->add_setting(
  ...
  $wp_customize->add_control( new themesflat_SocialIcons($wp_customize,
      ...
      array(
          ...
          'label' => esc_html__('Social Media', 'saylo'),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        ...
        'label' => esc_html__('Go To Button ( OFF | ON )', 'saylo'),
