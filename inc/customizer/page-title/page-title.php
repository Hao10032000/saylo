...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        ...
        'label' => esc_html__('Heading ( OFF | ON )', 'saylo'),
...
$wp_customize->add_control( new themesflat_Info( $wp_customize, 'page-title-style', array(
    ...
    'label' => esc_html__('Page Title Style', 'saylo'),
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'choices'   => array (
            ...
            'inline' =>  esc_html__( 'Inline Heading & Breadcrumbs','saylo' ),

            'default' =>  esc_html__( 'Default','saylo' ),

            'video' =>  esc_html__( 'Video','saylo' )
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'label'         => esc_html__('Page Title Alignment', 'saylo'),

        'choices'   => array (

            'left' =>  esc_html__( 'Left','saylo' ),

            'center' =>  esc_html__( 'Center','saylo' ),

            'right' =>  esc_html__( 'Right','saylo' )
...
$wp_customize->add_control(
    ...
    new WP_Customize_Image_Control(
        ...
        array(
           ...
           'label'          => esc_html__( 'Upload Background Image', 'saylo' ),
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'label'         => esc_html__('Page Title Image Size', 'saylo'),

        'choices'   => array (

            'auto' =>  esc_html__( 'Original','saylo' ),

            'contain' =>  esc_html__( 'Fit to Screen','saylo' ),

            'cover' =>  esc_html__( 'Fill Screen','saylo' )
...
$wp_customize->add_control(
    ...
    array(
        ...
        'label'     => esc_html__('Page Title Background Video URL', 'saylo'),
...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Background Color', 'saylo'),
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    ...
    array(
        ...
        'label' => esc_html__( 'Page Title Controls (px)', 'saylo' ),
