...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
        ...
        array(
            ...
            'label'     => esc_html__('Partner Box ( OFF | ON )', 'saylo'),
...
$wp_customize->add_control(
    ...
    new themesflat_MultiImages(
        ...
        array(
           ...
           'label'          => esc_html__( 'Upload Your Partner Image', 'saylo' ),
...
$wp_customize->add_control(
    ...
    array(
       ...
       'label'          => esc_html__( 'Show Number Image (Desktop)', 'saylo' ),
...
$wp_customize->add_control(
    ...
    array(
       ...
       'label'          => esc_html__( 'Show Number Image (Tablet)', 'saylo' ),
...
$wp_customize->add_control(
    ...
    array(
       ...
       'label'          => esc_html__( 'Show Number Image (Mobile)', 'saylo' ),
...
$wp_customize->add_control(
    ...
    array(
       ...
       'label'          => esc_html__( 'Gap Image', 'saylo' ),
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    ...
    array(
        ...
        'label' => esc_html__( 'Partner Box Controls (px)', 'saylo' ),
...
$wp_customize->add_control( 
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Partner Box Backgound', 'saylo'),
