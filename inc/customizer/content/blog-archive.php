...
$wp_customize->add_control( 
    ...
    array (
        ...
        'label'         => esc_html__('Blog Layout', 'saylo'),
...
$wp_customize->add_control(
    ...
    array(
        ...
        'label'     => esc_html__('Post Grid Columns', 'saylo'),
...
$wp_customize->add_control(
    ...
    array(
        ...
        'label'     => esc_html__('Post Per Page', 'saylo'),
...
$wp_customize->add_control( new themesflat_Control_Drag_And_Drop( $wp_customize,
    ...
    array(
        ...
        'label'     => esc_html__('Post Content Elements', 'saylo'),

        'description' => esc_html__( 'Drag and drop elements to re-order.', 'saylo' ),
        ...
        'choices' => array(
            ...
            'meta'            => esc_html__( 'Meta', 'saylo' ),

            'title'           => esc_html__( 'Title', 'saylo' ),

            'excerpt_content' => esc_html__( 'Excerpt', 'saylo' ),

            'readmore'        => esc_html__( 'Read More', 'saylo' ),
...
$wp_customize->add_control(
    ...
    array(
        ...
        'label'     => esc_html__('Read More Text', 'saylo'),
...
$wp_customize->add_control( new themesflat_Control_Drag_And_Drop( $wp_customize,
    ...
    array(
        ...
        'label'     => esc_html__('Meta Elements', 'saylo'),
        ...
        'choices' => array(
            ...
            'comment'   => esc_html__( 'Comment', 'saylo' ),
...
$wp_customize->add_control( 
    ...
    array(
        ...
        'label'         => esc_html__('Pagination Style', 'saylo'),

        'choices'   => array(

            'pager'     => esc_html__('Page','saylo'),

            'numeric'         =>  esc_html__('Numeric','saylo'),

            'pager-numeric'         =>  esc_html__('Page & Numeric','saylo'),
