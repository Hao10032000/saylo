...
$wp_customize->add_control( new themesflat_Typography($wp_customize,
    ...
    array(
        ...
        'label' => esc_html__( 'Font name/style/sets', 'saylo' ),
...
$wp_customize->add_control( 'h1_size', array(
    ...
    'label'       => esc_html__('H1 font size (px)', 'saylo'),
...
$wp_customize->add_control( 'h2_size', array(
    ...
    'label'       => esc_html__('H2 font size (px)', 'saylo'),
...
$wp_customize->add_control( 'h3_size', array(
    ...
    'label'       => esc_html__('H3 font size (px)', 'saylo'),
...
$wp_customize->add_control( 'h4_size', array(
    ...
    'label'       => esc_html__('H4 font size (px)', 'saylo'),
...
$wp_customize->add_control( 'h5_size', array(
    ...
    'label'       => esc_html__('H5 font size (px)', 'saylo'),
...
$wp_customize->add_control( 'h6_size', array(
    ...
    'label'       => esc_html__('H6 font size (px)', 'saylo'),
