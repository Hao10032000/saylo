...
$wp_customize->add_control( 
    ...
    array(
        ...
        'label'         => esc_html__('Layout version', 'saylo'),

        'choices'   => array(

            'wide'           =>  esc_html__('Wide','saylo'),

            'boxed'         =>   esc_html__('Boxed','saylo'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Body Background Color', 'saylo'),
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    ...
    array(
        ...
        'label' => esc_html__( 'Content Box Controls (px)', 'saylo' ),
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'label'         => esc_html__('Page Sidebar Position', 'saylo'),
