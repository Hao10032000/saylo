...
function themesflat_custom_styles( $custom ) {
	...
	//GROUP HEADER
		...
		if ( $header_backgroundcolor !='' ) {
			...
			$custom .= "#header.header-default { background:" . esc_attr($header_backgroundcolor) . ";}"."\n";
	...
	//GROUP FOOTER
		...
		// 	$custom .= ".form-ac-footer .content-left .content h2 { color:" . esc_attr($action_box_heading_color) . ";}"."\n";
		// }
		// // Action Box Text Color
		// $action_box_text_color = themesflat_get_opt( 'action_box_text_color');
		// if ( $action_box_text_color !='' ) {
		// 	$custom .= ".form-ac-footer .content-left .content h4 { color:" . esc_attr($action_box_text_color) . ";}"."\n";
		// }
		...
		// 	$custom .= ".form-ac-footer .content-left .icon { color:" . esc_attr($action_box_button_text_color) . ";}"."\n";
		// 	$custom .= ".form-ac-footer .content-left .icon svg, .form-ac-footer .content-left .icon svg path { fill:" . esc_attr($action_box_button_text_color) . ";}"."\n";
		// }
    ...
    //GROUP PAGE TITLE
		...
		$custom .= ".page-header  { background: ". esc_attr($page_title_background_color) .";}"."\n";
		...
		if ( $page_title_background_color_opacity !='' ) {
			...
			$custom .= ".page-header  { opacity:" . esc_attr($page_title_background_color_opacity) . "%; filter:alpha(opacity=" . esc_attr($page_title_background_color_opacity) . "); }"."\n";
